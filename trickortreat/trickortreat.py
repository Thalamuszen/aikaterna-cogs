...
class TrickOrTreat(commands.Cog):
    ...
    async def buycandy(self, ctx, pieces: int):
        ...
        candy_price = int(round(await bank.get_balance(ctx.author)) * 0.02) * pieces
        if candy_price in range(0, 3):
            candy_price = pieces
        try:
    ...
    async def on_message_without_command(self, message):
        ...
        walking_messages = [
            "*You hear footsteps behind you as you walk towards the next house, but as you turn around nobody is there...*",
            "*After approaching the next house you're left alone with your thoughts as you wait for the door to open...*",
            "*As you walk towards the next house the wind howls through the trees nearby...*",
            "*You walk slowly towards the next house and it starts to feel colder here all of a sudden...*",
            "*You walk up to an old dilapidated house and knock upon the door. Somewhere inside the house, you hear wood creaking...*",
            "*You approach a house with halloween ornaments on the front lawn and walk up the path to the door and knock...*",
            "*You walk up to a house and knock on the door and wait patiently for a moment before you hear approaching footsteps...*",
            "*You appraoch the house and knock softly upon the door and notice movement in the shadows by the side of the house...*",
        ]
        ...
        door_messages = [
            ...
            "*You hear someone talking inside before the door swings wide open...*",
            "*The wind whips around your feet as the door opens slowly...*",
            "*A crow caws ominously just as the door begins to open...*",
        ...
        greet_messages = [
            ...
            "The peppermint ones are my favourite, take one!",
            "Come back again later if you see the light on still. I have candy for days!",
            "Go ahead, take a few... A few more...",
